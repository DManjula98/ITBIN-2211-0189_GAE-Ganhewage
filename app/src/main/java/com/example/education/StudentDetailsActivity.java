...
public class StudentDetailsActivity extends AppCompatActivity {
    ...
    private Button updateButton, deleteButton, buttonBack;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        deleteButton.setOnClickListener(view -> deleteUserData());
        buttonBack.setOnClickListener(view -> {
            Intent intent = new Intent(StudentDetailsActivity.this, HomeActivity.class);
